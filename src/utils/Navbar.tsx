    ...
    return (
        <nav className="fixed top-0 left-0 z-2 w-full flex flex-row justify-between items-center p-4">
            ...
            <div className="flex flex-row items-center gap-4 pr-3">
                <Button variant={"default"} className="bg-white text-black hover:bg-orange-600 hover:text-white transition-all duration-300" onClick={() => router.push("/dashboard")}>Get Started</Button>
            </div>
        </nav>
    )
}