        ...
        <div className="min-h-screen bg-black text-white">
            ...
            <div className="border-b border-gray-700 bg-gray-900/80">
                <div className="flex h-16 items-center justify-between px-6">
                    ...
                    <div className="flex items-center space-x-4">
                        <Button variant="outline" size="sm" className="border-gray-600 text-black hover:border-gray-400">
                            Documentation
                        </Button>
            ...
            <div className="flex">
                {/* Sidebar */}
                <div className="w-64 border-r border-gray-700 bg-gray-900/50 min-h-screen">
                    <div className="p-4">
                ...
                <div className="flex-1 p-6">
                    ...
                    <div className="mb-6">
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex space-x-2">
                                ...
                                <Button variant="outline" size="sm" className="text-black border-gray-600 hover:border-gray-400">
                                    📊 Metrics
                                </Button>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <Card className="lg:col-span-2 bg-gray-900/80 border-gray-700">
                            <CardHeader>
                            ...
                            <CardContent>
                                <div className="h-64 bg-gray-800/80 rounded-lg flex items-center justify-center">
                        ...
                        <Card className="bg-gray-900/80 border-gray-700">
                            ...
                            <CardContent className="space-y-3">
                                <Button variant="outline" className="w-full justify-start text-black border-gray-600 hover:border-gray-400">
                                    🤖 Deploy New Agent
                                </Button>
                                <Button variant="outline" className="w-full justify-start text-black border-gray-600 hover:border-gray-400">
                                    🧠 Create Memory Node
